...
{
    public partial class ReportesEstadisticosCBD_tres : System.Web.UI.Page
    {
        ...
        protected string obtenerDatos()
        {
            ...
            cmd.CommandText = "Select Hamburguesas.Descripcion, COUNT (Cant_Hamburguesas) AS cantidad from Hamburguesas, Facturacion where Facturacion.cod_hamburguesa = Hamburguesas.cod_hamburguesa group by Hamburguesas.Descripcion";
        ...
        public DataTable dtplatillomasVendido()
        {
        ...
        protected void btnGenerarPDF_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                documento.Add(new Paragraph(20, "Reporte Platillo mas vendido", fontTitle));
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Platillomasvendido" + ".pdf");
