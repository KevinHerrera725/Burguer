...
namespace SistemasMultimediaBHO.vistas
{
    ...
    public partial class ReportesEstadisticosBDcuatro : System.Web.UI.Page
    {
       ...
       protected void Page_Load(object sender, EventArgs e)
        ...
        protected string obtenerVentas()
        {
            ...
            cmd.CommandText = "SELECT DATENAME(MONTH, Facturacion.Fecha) as Mes, SUM(Total) as total_ganancia_mes FROM Facturacion WHERE YEAR(Facturacion.Fecha) = '2021'Group by DATENAME(MONTH, Facturacion.Fecha)";
        ...
        protected void btnGenerarPDF_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                documento.Add(new Paragraph(20, "Reporte Ganancias", fontTitle));
            ...
            Response.AddHeader("content-disposition", "attachment;filename=GananciasMensuales" + ".pdf");
