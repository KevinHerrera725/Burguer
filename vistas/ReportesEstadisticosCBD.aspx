<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportesEstadisticosCBD.aspx.cs" Inherits="SistemasMultimediaBHO.vistas.ReportesEstadisticosCBD" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Reporte Diagrama Pie-Chart BD</title>
...
<body>
    <form id="form1" runat="server">
       ...
       <div class="banner-content">
           ...
           <asp:Button ID="bdtgenerarPDF" runat="server" Text="Descargar PDF" class="btn btn-info" OnClick="bdtgenerarPDF_Click" />
